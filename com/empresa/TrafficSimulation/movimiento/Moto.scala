...
class Moto (val pl:String, val o:Interseccion, val d:Interseccion, private var _v:Velocidad, val c : Color = Color.WHITE/*, val figura:??*/) extends Vehiculo(pl, o, d, _v, c){
