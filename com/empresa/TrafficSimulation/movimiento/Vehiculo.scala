...
object Vehiculo{
  ...
  val proporcionCarros: Array[String] = Array.fill(Json.carros.toInt*100)("carro")
  val proporcionMotos: Array[String] = Array.fill(Json.motos.toInt*100)("moto")
  val proporcionMotoTaxis: Array[String] = Array.fill(Json.motoTaxis.toInt*100)("mototaxi")
  val proporcionCamion: Array[String] = Array.fill(Json.camiones.toInt*100)("camion")
  val proporcionBus: Array[String] = Array.fill(Json.buses.toInt*100)("bus")
