...
import grafico.{Grafico, GrafoVia}
...
object Simulacion extends Runnable{
  ...
  // Se crea un array de vehículos que se va ir llenando cada que se crea un vehiculo
  ...
  GrafoVia.construir(vias.to[ArrayBuffer])
  Grafico.graficarVias(vias)
  Thread.sleep(5000)
  var t = 0
  var Running = 0
  Running = start()
